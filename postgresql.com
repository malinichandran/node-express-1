...
<html lang="en">
 <head>
  ...
  <meta property="article:published_time" content="2021-05-28T06:34:13.032122" />
  ...
  <link href="/media/css/fontawesome.css?2fa136f9" rel="stylesheet">
  <link rel="stylesheet" href="/media/css/bootstrap-4.4.1.min.css">
  <link rel="shortcut icon" href="/favicon.ico" />
  
    <link rel="stylesheet" type="text/css" href="/dyncss/base.css?2fa136f9">
    ...
    <div class="col-lg-5">
      <div class="sidebar">
        ...
        <ul class="divided">
            ...
            <li>
              <h3><a href="/about/news/sqlite-fdw-200-released-2222/">SQLite fdw 2.0.0 released</a></h3>
              <ul class="meta">
                <li><i class="far fa-clock"></i>&nbsp;2021-05-26 by Toshiba</li>
              </ul>
            </li>
            ...
            <li>
              <h3><a href="/about/news/influxdb-fdw-100-released-2224/">InfluxDB fdw 1.0.0 released</a></h3>
              <ul class="meta">
                <li><i class="far fa-clock"></i>&nbsp;2021-05-26 by Toshiba</li>
              </ul>
            </li>
...
<!-- Blog -->
     ...
     <!-- First Column First Row Planet PostgreSQL -->
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/54Z"> New Features in PostgreSQL 14: Bulk Inserts for Foreign Data Wrappers</a></h3>
            <ul class="meta">
              <li><i class="far fa-comments"></i>&nbsp;Ibrar Ahmed</li>
              <li><i class="far fa-clock"></i>&nbsp;2021-05-27</li>
            </ul>
          </div>
        </div>
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/54Y"> How to interpret PostgreSQL EXPLAIN ANALYZE output</a></h3>
            <ul class="meta">
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/54X"> Enhancements to the target_session_attrs database connection parameter in PostgreSQL</a></h3>
            <ul class="meta">
              <li><i class="far fa-comments"></i>&nbsp;Greg Nancarrow</li>
              <li><i class="far fa-clock"></i>&nbsp;2021-05-27</li>
            </ul>
          </div>
        </div>
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/54W"> Encrypting Logical Backups</a></h3>
            <ul class="meta">
              <li><i class="far fa-comments"></i>&nbsp;Bruce Momjian</li>
              <li><i class="far fa-clock"></i>&nbsp;2021-05-26</li>
            </ul>
          </div>
        </div>
 ...
 <!-- END SUBMIT A BUG -->
    ...
    <script src="/media/js/main.js?2fa136f9"></script>
